...
<head>
    ...
    <title>Seaba Seafood Management System - Staff Login</title>
...
<body>
    <!-- Staff/Manager Login Page Content -->
    <div class="container">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="card mt-5">
                    <div class="card-body">
                        ...
                        <form action="validateStaff.jsp" method="POST" class="row g-3 needs-validation">
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                ...
                                <input type="password" name="staffPassword" class="form-control" id="password"
                        ...
                        <div class="text-center mt-3">
                            <p class="small">Don't have an account? <a href="registerStaff.jsp">Register here</a></p>
                        </div>
                        <div class="text-center mt-3">
                        ...
                        <% String success = request.getParameter("success");
                            if (success != null && success.equals("1")) { %>
                                <script>
                                    ...
                                    setTimeout(function () {
                                        window.location.replace("staff.jsp");
                                    }, 2000);
                                </script>
                        <%  } %>
                    </div>
